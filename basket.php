                                ...
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        <div class="d-flex justify-content-between align-items-center mb-5">
                                            ...
                                            <h6 class="mb-0 text-muted"><?php count($good) ?> items</h6>
                                        </div>

                                        <hr class="my-4">

                                        <?php foreach ($_POST as $name => $order) {
                                            foreach ($goods as $good) ?>
                                                <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                        ...
                                                        <?php if ($order >= $good['numberOf']) {
                                                            echo 'Not in stock' . ' ' . $good['name'] . "</br>";
                                                        } ?>
                                ...
                                <div class="col-lg-4 bg-grey">
                                    <div class="p-5">
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            <h5 class="text-uppercase">items <?php count($good) ?></h5>
                                            <h5><?php $good['price'] * $order?></h5>
                                        </div>
